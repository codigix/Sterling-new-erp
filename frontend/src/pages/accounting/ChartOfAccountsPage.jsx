...
const ChartOfAccountsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      key: "name",
      label: "Account Name",
      render: (val) => <span className="font-bold text-slate-800 dark:text-slate-200">{val}</span>
    },
    {
      key: "type",
      label: "Type",
    ...
    },
    {
      ...
      align: "right",
      render: (val) => <span className="font-bold text-slate-700">₹${val.toLocaleString()}</span>
    },
    {
      key: "status",
      label: "Status",
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700">
          <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Total Assets</p>
          <p className="text-lg font-bold text-blue-600 font-mono">₹2,395,000</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700">
          <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Total Liabilities</p>
          <p className="text-lg font-bold text-orange-600 font-mono">₹225,000</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700">
          <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Total Revenue</p>
          <p className="text-lg font-bold text-emerald-600 font-mono">₹450,000</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700">
          <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Total Expenses</p>
          <p className="text-lg font-bold text-red-600 font-mono">₹125,000</p>
        </div>
      </div>
