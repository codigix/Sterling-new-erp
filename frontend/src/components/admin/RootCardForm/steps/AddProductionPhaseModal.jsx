      ...
      <form onSubmit={handleSubmit}>
        <ModalBody className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <textarea
              className="w-full p-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 dark:text-slate-100"
