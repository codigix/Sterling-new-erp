    ...
    try {
        ...
        if (items && items.length > 0) {
            ...
            const itemValues = items.map(item => [
                ...
                item.remark || '',
                item.item_group || '',
                (type === 'inbound' && item.vendor_length) ? item.vendor_length : (item.length || null),
                (type === 'inbound' && item.vendor_width) ? item.vendor_width : (item.width || null),
                (type === 'inbound' && item.vendor_thickness) ? item.vendor_thickness : (item.thickness || null),
                (type === 'inbound' && item.vendor_diameter) ? item.vendor_diameter : (item.diameter || null),
                (type === 'inbound' && item.vendor_outer_diameter) ? item.vendor_outer_diameter : (item.outer_diameter || null),
                (type === 'inbound' && item.vendor_height) ? item.vendor_height : (item.height || null),
                item.material_type || null,
                item.density || 0,
                item.unit_weight || 0,
                (type === 'inbound' && item.vendor_side1) ? item.vendor_side1 : (item.side1 || 0),
                (type === 'inbound' && item.vendor_side2) ? item.vendor_side2 : (item.side2 || 0),
                (type === 'inbound' && item.vendor_web_thickness) ? item.vendor_web_thickness : (item.web_thickness || 0),
                (type === 'inbound' && item.vendor_flange_thickness) ? item.vendor_flange_thickness : (item.flange_thickness || 0),
