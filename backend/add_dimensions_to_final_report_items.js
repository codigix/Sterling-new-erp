...
const addDimensionsToFinalReportItems = async () => {
    try {
        const table = 'quality_final_report_items';
        const columns = [
        ...
        console.log('Quality Final Report items table update completed');
        process.exit(0);
    } catch (error) {
        console.error('Failed to update Quality Final Report items table:', error);
        process.exit(1);
    }
};

addDimensionsToFinalReportItems();
