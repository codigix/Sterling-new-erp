...
const RecordVendorPaymentModal = ({ isOpen, onClose, onPaymentRecorded, editData = null, initialViewMode = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in duration-200">
        {/* Header */}
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Record Vendor Payment</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-bold text-slate-400">Payment #</label>
                <input
                  type="text"
                  name="payment_number"
                  ...
                  readOnly={viewMode}
                  className={`w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-mono focus:ring-2 focus:ring-emerald-500/20 outline-none ${viewMode ? 'cursor-default' : ''}`}
                  required
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-bold text-slate-400">Payment Date</label>
                <input
                  type="date"
                  name="payment_date"
                  ...
                  onChange={handleInputChange}
                  readOnly={viewMode}
                  className={`w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500/20 outline-none ${viewMode ? 'cursor-default' : ''}`}
                  required
                />
              </div>
            </div>
            ...
            {/* Invoice Selection */}
            <div className="space-y-1.5">
              <label className="text-[10px] uppercase font-bold text-slate-400">Select Invoice to Pay</label>
              {viewMode ? (
            ...
            {formData.invoice_id && (
              <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-800 space-y-2">
                ...
                <div className="flex justify-between text-xs pt-1 border-t border-slate-200 dark:border-slate-700">
                  ...
                  <span className="font-bold text-red-600">₹{formData.balance_amount.toLocaleString()}</span>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-bold text-slate-400">Amount to Pay (₹)</label>
                <input
                  type="number"
                  name="amount_paid"
                  ...
                  onChange={handleInputChange}
                  readOnly={viewMode}
                  className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-bold focus:ring-2 focus:ring-emerald-500/20 outline-none text-emerald-600 ${viewMode ? 'cursor-default' : ''}`}
                  placeholder="0.00"
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  disabled={viewMode}
                  className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500/20 outline-none ${viewMode ? 'cursor-default appearance-none' : ''}`}
                >
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] uppercase font-bold text-slate-400">Reference / Transaction #</label>
              <input
                type="text"
                ...
                onChange={handleInputChange}
                readOnly={viewMode}
                className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500/20 outline-none ${viewMode ? 'cursor-default' : ''}`}
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                readOnly={viewMode}
                className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm h-20 resize-none outline-none ${viewMode ? 'cursor-default' : ''}`}
