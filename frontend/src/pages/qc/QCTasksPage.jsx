                  ...
                  <div className="flex items-center gap-2">
                    {!report.is_sent_to_inventory ? (
                      <button 
                        ...
                        className={`p-2 bg-blue-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center gap-2 ${sendingReport === report.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
