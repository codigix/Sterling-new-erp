...
Save the PRD into `d:\passion\Sterling-erp\.zencoder\chats\f6759966-4568-4f86-b985-cf8ae01148a1/requirements.md`.

### [ ] Step: Technical Specification

Based on the PRD in `d:\passion\Sterling-erp\.zencoder\chats\f6759966-4568-4f86-b985-cf8ae01148a1/requirements.md`, create a detailed technical specification to be used by a coding agent to implement the feature. Follow this template:
...
Save the spec to `d:\passion\Sterling-erp\.zencoder\chats\f6759966-4568-4f86-b985-cf8ae01148a1/spec.md`.

### [ ] Step: Implementation Plan

Based on the technical spec in `d:\passion\Sterling-erp\.zencoder\chats\f6759966-4568-4f86-b985-cf8ae01148a1/spec.md`, create a detailed task plan and update `d:\passion\Sterling-erp\.zencoder\chats\f6759966-4568-4f86-b985-cf8ae01148a1/plan.md`. Each task should have task definition, references to contracts to be used/implemented, deliverable definition and verification instructions.
